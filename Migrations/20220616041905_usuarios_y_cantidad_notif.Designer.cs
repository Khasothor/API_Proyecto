...
namespace WebApi2.Migrations
{
    ...
    [Migration("20220616041905_usuarios_y_cantidad_notif")]
    partial class usuarios_y_cantidad_notif
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApi2.Models.Persona.ConfigUsuario", b =>
                {
                    ...
                    b.Property<int?>("Usuario_UsuarioId")
                        .HasColumnType("int");

                    b.HasKey("ConfigUsuarioId");

                    b.HasIndex("Usuario_UsuarioId");
            ...
            modelBuilder.Entity("WebApi2.Models.Persona.ConfigUsuario", b =>
                {
                    b.HasOne("WebApi2.Models.Persona.Usuario", "Usuario_")
                        .WithMany()
                        .HasForeignKey("Usuario_UsuarioId");
